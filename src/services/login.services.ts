...
import { ReturnClientInterface } from '../interfaces/Clients.interface'


export const loginService = async (payload: LoginRequest): Promise<{token:string, user: ReturnClientInterface}> => {
